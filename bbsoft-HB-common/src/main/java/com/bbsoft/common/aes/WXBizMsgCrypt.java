...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String corpId){
		if (encodingAesKey.length() != 43) {
			throw new ServiceException(MsgeData.SYSTEM_10100.getCode(), "SymmetricKey非法");
		}
	...
	String encrypt(String randomStr, String text) {
		...
		try {
			...
			e.printStackTrace();
			throw new ServiceException(MsgeData.SYSTEM_10100.getCode(), "aes加密失败");
		}
	}
	...
	String decrypt(String text) {
		...
		try {
			...
			e.printStackTrace();
			throw new ServiceException(MsgeData.SYSTEM_10100.getCode(), "aes解密失败");
		}
		...
		try {
			...
			e.printStackTrace();
			throw new ServiceException(MsgeData.SYSTEM_10100.getCode(), "解密后得到的buffer非法");
		}

		// corpid不相同的情况
		if (!from_corpid.equals(corpId)) {
			throw new ServiceException(MsgeData.SYSTEM_10100.getCode(), "corpid校验失败");
		}
		return xmlContent;
	...
	public String DecryptMsg(String msgSignature, String timeStamp, String nonce, String postData){
		...
		if (!signature.equals(msgSignature)) {
			throw new ServiceException(MsgeData.SYSTEM_10101.getCode(), "签名验证错误");
		}
